(function() {
    ...
    THREE.CSS3DObject = function(a) {
        ...
        this.addEventListener("removed", function(a) { if (null !== this.element.parentNode) { this.element.parentNode.removeChild(this.element); for (var c = 0, d = this.children.length; c < d; c++) this.children[c].dispatchEvent(a) } })
    };
    ...
    THREE.CSS3DRenderer = function() {
        ...
        var g = function(a) { return 1E-6 > Math.abs(a) ? 0 : a },
            m = function() {
    ...
    var _ = {
        ...
        hexToRgb: function(a) { a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(a, c, d, e) { return c + c + d + d + e + e }); return (a = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a)) ? { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16) } : null }
    };
    ERNO.extend(Number.prototype, {
        absolute: function() { return Math.abs(this) },
        add: function() {
            var a = this;
            Array.prototype.slice.call(arguments).forEach(function(b) { a += b });
            return a
        },
        arcCosine: function() { return Math.acos(this) },
        arcSine: function() { return Math.asin(this) },
        arcTangent: function() { return Math.atan(this) },
        ...
        cosine: function() { return Math.cos(this) },
        ...
        degreesToRadians: function() { return this * Math.PI / 180 },
        divide: function() {
            var a = this;
            Array.prototype.slice.call(arguments).forEach(function(b) { a /= b });
            return a
        ...
        lerp: function(a, b) { return a + (b - a) * this },
        log: function(a) { return Math.log(this) / (void 0 === a ? 1 : Math.log(a)) },
        log10: function() {
            return Math.log(this) /
                Math.LN10
        },
        maximum: function(a) { return Math.max(this, a) },
        minimum: function(a) { return Math.min(this, a) },
        modulo: function(a) { return (this % a + a) % a },
        multiply: function() {
            var a = this;
            Array.prototype.slice.call(arguments).forEach(function(b) { a *= b });
            return a
        },
        normalize: function(a, b) { return a == b ? 1 : (this - a) / (b - a) },
        raiseTo: function(a) { return Math.pow(this, a) },
        radiansToDegrees: function() { return 180 * this / Math.PI },
        rand: function(a) {
            var b;
            return void 0 !== a ? (b = Math.min(this, a), a = Math.max(this, a), b + Math.floor(Math.random() *
                (a - b))) : Math.floor(Math.random() * this)
        },
        random: function(a) { var b; return void 0 !== a ? (b = Math.min(this, a), a = Math.max(this, a), b + Math.random() * (a - b)) : Math.random() * this },
        remainder: function(a) { return this % a },
        round: function(a) {
            var b;
            a = a || 0;
        ...
        roundDown: function() { return Math.floor(this) },
        roundUp: function() { return Math.ceil(this) },
        scale: function(a, b, c, d) { a = this.normalize(a, b); return c == d ? d : c + a * (d - c) },
        sine: function() { return Math.sin(this) },
        subtract: function() {
            var a =
                this;
            Array.prototype.slice.call(arguments).forEach(function(b) { a -= b });
        ...
        tangent: function() { return Math.tan(this) },
        toArray: function() { return [this.valueOf()] },
        toNumber: function() { return this.valueOf() },
        toPaddedString: function(a) { return ("0000000000000" + String(this)).slice(-a) },
    ...
    ERNO.extend(String.prototype, {
        ...
        justifyLeft: function(a) { for (var b = this; b.length < a;) b += " "; return b },
        justifyRight: function(a) { for (var b = this; b.length < a;) b = " " + b; return b },
        multiply: function(a) {
            var b, c = "";
            a = _.cascade(a, 2);
        ...
        reverse: function() { var a, b = ""; for (a = 0; a < this.length; a++) b = this[a] + b; return b },
        size: function() { return this.length },
        toEntities: function() { var a, b = ""; for (a = 0; a < this.length; a++) b += "&#" + this.charCodeAt(a) + ";"; return b },
        ...
        toNumber: function() { return parseFloat(this) },
        toString: function() { return this },
        toUnderscoreCase: function() { var a = this.replace(/[A-Z]+/g, function(a) { return "_" + a }); "_" === a.charAt(0) && (a = a.substr(1)); return a.toLowerCase() },
        toUnicode: function() {
            var a, b, c = "";
    ...
    ERNO.extend(Array.prototype, {
        distanceTo: function(a) {
            ...
            if (this.length === a.length) { for (b = 0; b < this.length; b++) c += Math.pow(a[b] - this[b], 2); return Math.pow(c, 0.5) }
            return null
        },
        first: function() { return this[0] },
        last: function() { return this[this.length - 1] },
        maximum: function() { return Math.max.apply(null, this) },
        middle: function() { return this[Math.round((this.length - 1) / 2)] },
        minimum: function() { return Math.min.apply(null, this) },
        rand: function() {
        ...
        toArray: function() { return this },
        toHtml: function() { var a, b = "<ul>"; for (a = 0; a < this.length; a++) b = this[a] instanceof Array ? b + this[a].toHtml() : b + ("<li>" + this[a] + "</li>"); return b + "</ul>" },
        toText: function(a) {
            var b, c, d;
            a = _.cascade(a, 0);
            c = "\n" + "\t".multiply(a);
    ...
    ERNO.Twist.prototype.set = function(a, b) {
        var c = { X: "Cube on X", L: "Left face", M: "Middle slice", R: "Right face", Y: "Cube on Y", U: "Up face", E: "Equator slice", D: "Down face", Z: "Cube on Z", F: "Front face", S: "Standing slice", B: "Back face" }[a.toUpperCase()];
        if (void 0 !== c) {
    ...
    ERNO.extend(ERNO.Cubelet.prototype, {
        ...
        hasColor: function(a) {
            ...
            for (a = 0; 6 > a; a++)
                if (c = _.hexToRgb(this.faces[a].color.hex), c.r === d.r && c.g === d.g && c.b === d.b) { b = a; break }
    ...
    ERNO.extend(ERNO.Group.prototype, {
        ...
        isTweening: function() { return this.isFlagged("isTweening") },
        isEngagedX: function() { return this.isFlagged("isEngagedX") },
        isEngagedY: function() { return this.isFlagged("isEngagedY") },
        isEngagedZ: function() { return this.isFlagged("isEngagedZ") },
        isEngaged: function() { return this.isEngagedX() + this.isEngagedY() + this.isEngagedZ() },
        hasProperty: function(a, b) {
            var c = new ERNO.Group;
            this.cubelets.forEach(function(d) { d[a] === b && c.add(d) });
            return c
        },
        hasId: function(a) { return this.hasProperty("id", a) },
        hasAddress: function(a) { return this.hasProperty("address", a) },
        hasType: function(a) { return this.hasProperty("type", a) },
        hasColor: function(a) {
        ...
        show: function() { this.cubelets.forEach(function(a) { a.show() }); return this },
        hide: function() { this.cubelets.forEach(function(a) { a.hide() }); return this },
        showPlastics: function() { this.cubelets.forEach(function(a) { a.showPlastics() }); return this },
        hidePlastics: function() {
            this.cubelets.forEach(function(a) { a.hidePlastics() });
            return this
        },
        showExtroverts: function() { this.cubelets.forEach(function(a) { a.showExtroverts() }); return this },
        hideExtroverts: function() { this.cubelets.forEach(function(a) { a.hideExtroverts() }); return this },
        showIntroverts: function(a, b) { this.cubelets.forEach(function(c) { c.showIntroverts(a, b) }); return this },
        hideIntroverts: function(a, b) { this.cubelets.forEach(function(c) { c.hideIntroverts(a, b) }); return this },
        showStickers: function() { this.cubelets.forEach(function(a) { a.showStickers() }); return this },
        hideStickers: function() {
            this.cubelets.forEach(function(a) { a.hideStickers() });
            return this
        },
        showWireframes: function() { this.cubelets.forEach(function(a) { a.showWireframes() }); return this },
        hideWireframes: function() { this.cubelets.forEach(function(a) { a.hideWireframes() }); return this },
        showIds: function() { this.cubelets.forEach(function(a) { a.showIds() }); return this },
        hideIds: function() { this.cubelets.forEach(function(a) { a.hideIds() }); return this },
        showTexts: function() { this.cubelets.forEach(function(a) { a.showTexts() }); return this },
        hideTexts: function() {
        ...
        setOpacity: function(a, b) { this.cubelets.forEach(function(c) { c.setOpacity(a, b) }); return this },
        getRadius: function() {
            var a = 0;
            this.cubelets.forEach(function(b) { a += b.getRadius() });
            return a / this.cubelets.length
        },
        setRadius: function(a, b) { this.cubelets.forEach(function(c) { c.setRadius(a, b) }); return this }
    });
    ...
    ERNO.extend(ERNO.Slice.prototype, {get origin() { return this.cube.cubelets[this.indices[4]] },
        ...
        get cubelets() { for (var a = [], b = this.indices.length; 0 < b--;) a.push(this.getCubelet(b)); return a },
        map: function(a, b) {
            for (var c = 0; 6 > c; c++)
        ...
        get rotation() { return this.axis.rotation },
    ...
    ERNO.Projector = function() {
        return function(a, b) {
            ...
            function d(d, f, l) {
                var t = b,
                    k = t !== document ? t.getBoundingClientRect() : { left: 0, top: 0, width: window.innerWidth, height: window.innerHeight };
    ...
    ERNO.Interaction = function() {
        return function(a, b, c, d, e) {
            ...
            var F = function(a, b) {
                    ...
                    return c ? (this.dispatchEvent(new CustomEvent("click", { detail: c })), !0) : !1
                }.bind(v),
                y, z;
    ...
    ERNO.Controls = function() {
        ...
        return function(c, d, e) {
            function f(b) { n.enabled && 1 === b.which && null === A.getIntersection(d, b.pageX, b.pageY) && (p = a, k.multiplyScalar(0), w(b.pageX, b.pageY, l), u.copy(l), n.domElement.removeEventListener("mousedown", f), document.addEventListener("mousemove", h), document.addEventListener("mouseup", g)) }

            function h(b) { n.enabled && (b.preventDefault(), p = a, w(b.pageX, b.pageY, l), k.subVectors(l, u), u.copy(l)) }
            ...
            function m(b) { n.enabled && null === A.getIntersection(d, b.touches[0].pageX, b.touches[0].pageY) && (p = a, k.multiplyScalar(0), w(b.touches[0].pageX, b.touches[0].pageY, l), u.copy(l), n.domElement.removeEventListener("touchstart", m), document.addEventListener("touchend", q), document.addEventListener("touchmove", s)) }

            function s(b) { n.enabled && (p = a, w(b.changedTouches[0].pageX, b.changedTouches[0].pageY, l), k.subVectors(l, u), u.copy(l)) }
            ...
            var u = new THREE.Vector2,
                ...
                n = { enabled: !0, domElement: e, rotationSpeed: 4, damping: 0.25 },
                w = function(a, b, c) {
                    var e;
                    e = n.domElement;
    ...
    ERNO.renderers.CSS3D = function(a, b) {
        function c(a) { a.style.display = "block" }

        function d(a) { a.style.display = "none" }

        function e() { return Array.prototype.slice.call(h.domElement.querySelectorAll(".faceLabel")) }
    ...
    ERNO.renderers.CSS3DCubelet.methods = function() {
        function a(a) { a.style.display = "block" }

        function b(a) { a.style.display = "none" }
        return {
            getFaceElements: function(a) { return Array.prototype.slice.call(this.css3DObject.element.querySelectorAll(".face" + (a || ""))) },
            show: function() {
            ...
            showPlastics: function() {
                this.getFaceElements().forEach(function(a) { a.classList.remove("faceTransparent") });
                this.showingPlastics = !0
            },
            hidePlastics: function() {
                this.getFaceElements().forEach(function(a) { a.classList.add("faceTransparent") });
            ...
            getStickersOpacity: function(a) { return parseFloat(this.getFaceElements(" .sticker")[0].style.opacity) },
    ...
    ERNO.Cube = function(a) {
        ...
        [
            ...
            [, , , R, , Y],
            [, , B, R, , Y]
        ].forEach(function(a, b) { this.cubelets.push(new ERNO.Cubelet(this, b, a)) }.bind(this));
        ...
        this.mouseInteraction.addEventListener("click", function(a) {
            this.dispatchEvent(new CustomEvent("click", { detail: a.detail }))
        }.bind(this));
    ...
    ERNO.extend(ERNO.Cube.prototype, {
        ...
        solve: function() { this.isSolving = !0 },
        isSolved: function() {
        ...
        undo: function() { 0 < this.twistQueue.history.length && (this.historyQueue.add(this.twistQueue.undo().getInverse()), this.undoing = !0) },
        redo: function() { 0 < this.twistQueue.future.length && (this.undoing = !0, this.historyQueue.empty(), this.historyQueue.add(this.twistQueue.redo())) },
        twist: function(a) {
            this.undoing &&
        ...
        immediateTwist: function(a) {
            ...
            (new TWEEN.Tween(b)).to({ rotation: d },
                ...
                a === this.finalShuffle && (this.finalShuffle = null, this.dispatchEvent(new CustomEvent("onShuffleComplete", { detail: { slice: b, twist: a } })))
        ...
        setText: function(a, b) { void 0 === b ? (this.folds[0].setText(a), this.folds[1].setText(a), this.folds[2].setText(a)) : _.isNumeric(b) && 0 <= b && 2 >= b && this.folds[b].setText(a) },
